            ...
            <ul class="media-list">
              <li class="media">
                <div class="media">
                  <div class="media-left">
                    <a href="#">
                      <img src="BETS.png" class="media-object" >
                    </a>
                  </div><!-- /.media-left-->
                  <div class="media-body">
                  ...
                  <div class="media-body">
                   <strong><h4 class = "media-heading">Índice Espacial de Preços ao Consumidor para o Rio de Janeiro</h4></strong>
                    <br>
                      ...
                      Índice Espacial de Preços ao Consumidor (IEPC-RJ) por regiões da cidade do Rio de Janeiro.
                      </h5> 
                    </div><!--/media body-->
                </div><!--/media -->
              </li><!--/li media -->
                  ...
                  <div class="media-body">
                   <strong><h4 class = "media-heading">Aprimoramento das Sondagens Empresariais FGV|IBRE</h4></strong>
                    <br>
                      ...
                      produzidas pela Superintendência Adjunta de Ciclos Econômicos (FGV|IBRE). São elas: (a) Espelho das Sondagens Empresariais
                      em Matlab. Todas as Sondagens Empresariais (Indústria, Comércio, Serviços e Construção) foram reprogramadas em Matlab e uma 
                      ...
                      as Sondagens; (b) Reponderação Matricial Redistribuição dos pesos das empresas na pesquisa em caso de não resposta. Antes a 
                      redistribuição era setorial, agora é matricial. (c) Backcasting Comércio. Na Sondagem do Comércio, havia uma série importante
                      que começava aproximadamente 10 meses depois. (d) Desenvolvemos e repassamos a tecnologia que consiste em inverter a série, 
                      fazer uma regressão (log-log) e a partir daí fazer a previsão da série. (e) Padronização das Sondagens Empresariais. Após 
                      amplo estudo sobre a literatura das Sondagens e seguindo a recomendação da Comissão Europeia (The Joint Harmonised EU 
                      ...
                      para garantir que as séries mais voláteis não dominassem o indicador final após a agregação. (f) Desenvolvimento de um sistema computacional em R 
                      para fazer o ajuste sazonal: O X13-ARIMA-SEATS permitiu uma melhora na qualidade do produto final e também um aumento da produtividade dos 
                      ...
                      mesma tarefa é realizada em minutos.
                      </h5> 
                    </div><!--/media body-->
                </div><!--/media -->
              </li><!--/li media -->
            ...
            <ul class="media-list">
              <li class="media">
                <div class="media">
                  ...
                  <div class="media-body">
                   <strong><h4 class = "media-heading">Estudo sobre sazonalidade(link)</h4></strong>
                    <br>
                  ...
                  <div class="media-body">
                   <strong><h4 class = "media-heading">Cursos in company</h4></strong>
                    <br>
                      ...
                      - Ampla Energia e Serviços S.A. (concessionária de distribuição de energia elétrica que atua no Estado do Rio de Janeiro)
                      - Operador Nacional do Sistema Elétrico (ONS)
                      - CEB (Companhia Energética de Brasília)
                      - Universidade UNINOVE
                      - Duke Energy International, Geração Paranapanema, DEI-GP, Brasil, entre outras.
                    </div><!--/media body-->
                </div><!--/media -->
              </li><!--/li media -->
            </ul><!--/ul media-list -->
